...
class User(AbstractUser):
    ...
    selected_repo = models.ForeignKey(
        "Repository",  # Referencing Repository as a string
        null=True,
        blank=True,
...
class License(models.Model):
    repository = models.OneToOneField(
        Repository, on_delete=models.CASCADE, related_name="license"
    )
...
class RepositoryPermission(models.Model):
    repository = models.OneToOneField(
        Repository, on_delete=models.CASCADE, related_name="permissions"
    )
